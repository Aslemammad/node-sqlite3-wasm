...
const sqlite3 = new class a{};
// const sqlite3 = require('./sqlite3-binding.js');
const inject = require('./constants.js')
inject(sqlite3)
const EventEmitter = require('events').EventEmitter;
const MockedStatement = require('./wasm/statement.js')
const MockedDatabase = require('./wasm/database.js')

module.exports = exports = sqlite3;
sqlite3.Statement = MockedStatement;
sqlite3.Database = MockedDatabase;
